...
<html>
  ...
  <body>
   <%
	...
	%>
	<%
	Student admin=(Student)request.getSession().getAttribute("stu");
	 %>
   <!--====================================================
                         MAIN NAVBAR
======================================================-->        
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        <form action="student/PwdUpdate" method="POST">
                            <div class="row mt-3">
                                <div class="col-md-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="StuID" id="StuID" readonly="readonly" value="<%=admin.getStuID()%>">
                                    </div> 
                                    <div class="form-group">
                                      <div class="form-group">
