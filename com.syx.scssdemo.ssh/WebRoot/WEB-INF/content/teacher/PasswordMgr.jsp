...
<html>
  ...
  <body>
   <%
	...
	%>
	<%
	Teacher admin=(Teacher)request.getSession().getAttribute("tea");
	 %>
   <!--====================================================
                         MAIN NAVBAR
======================================================-->        
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        <form action="teacher/PwdUpdate" method="POST">
                            <div class="row mt-3">
                                <div class="col-md-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="TeacherID" id="TeacherID" readonly="readonly" value="<%=admin.getTeacherID()%>">
                                    </div> 
                                    <div class="form-group">
                                      <div class="form-group">
