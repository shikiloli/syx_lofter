		    ...
		    function tableload(){				
				$.ajax({
					...
					success:function(json){
						...
						trhtml+="<td><a href='notice/NoticeFind?id="+json[i].ID+"'>查看</a>&nbsp&nbsp&nbsp&nbsp<a onclick='del()' href='notice/NoticeDelete?id="+json[i].ID+"' class='del'>删除</a></td></tr>";	
		...
		<script type="text/javascript">
           function del(){
                  ...
                  if(res == true){
                   		...
                   		$(".del").attr("href", "admin/NoticeInfo");
                   }
            }
    </script>
</body>
