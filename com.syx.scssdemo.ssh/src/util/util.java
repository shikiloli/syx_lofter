...
public class util {
	 ...
	 * @return 学期
	 */
	public static String getNowXue(){
	...
	*/
	...
	public static Object concerNull(Object ob){
		if(ob==null){
			return " ";
		}
		return ob;
	 ...
	 * @throws Exception 异常
	 */
	public static String fileupload(HttpServlet servlet,HttpServletRequest request, String dirname, String fileName) throws Exception {
		 // 配置上传参数
	 ...
	 * @throws Exception 异常
	 */
	public static String fileupload2(HttpServletRequest request, String dirname, String fileName) throws Exception {
		 // 配置上传参数
        DiskFileItemFactory factory = new DiskFileItemFactory();
        // 设置内存临界值 - 超过后将产生临时文件并存储于临时目录中
        factory.setSizeThreshold(1024 * 1024 * 3);
        ...
        String uploadPath = request.getSession().getServletContext().getRealPath("") + dirname;
