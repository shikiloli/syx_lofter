...
public class TeacherPhoto extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Teacher tea=(Teacher)request.getSession().getAttribute("tea");//获取对象
		imageFileName=tea.getPhoto();//设置文件名为对象照片字段
		String realpath = ServletActionContext.getServletContext().getRealPath("/teacherphoto");//获取服务器所在路径+设置文件所在路径
