...
public class AdminPhoto extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Admin admin=(Admin)request.getSession().getAttribute("admin");//获取对象
		imageFileName=admin.getPhoto();//设置文件名为对象照片字段
		String realpath = ServletActionContext.getServletContext().getRealPath("/adminphoto");//获取服务器所在路径+设置文件所在路径
